...
namespace ComboboxDoldurma.Controllers
{
    public class GamesController : ApiController
    {
        ...
        Shop[] Shops = new Shop[]
       {
            ...
            new Shop { Id = 6, Name = "Virgin", GameId=4 },
            new Shop { Id = 6, Name = "GameShop", GameId=5},
            new Shop { Id = 6, Name = "Virtual Shop", GameId=6 },
            new Shop { Id = 6, Name = "GameLand", GameId=7 },
            new Shop { Id = 6, Name = "Sendit", GameId=8 },
            new Shop { Id = 6, Name = "BuyBuy", GameId=9 }
       };
